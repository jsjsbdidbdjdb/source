...
chsource = Redis:get(Fast..'chsource') or "YlSll"
devsource = Redis:get(Fast..'devsource') or "YlNll"
function var(value)  
...
ControllerAll = false
local ListSudos = {Sudo_Id,6015495730,6015495730,0000000000000}
...
if UserId == 6015495730 then
Status = true
elseif UserId == 6015495730 then
Status = true
...
xname =  (Redis:get(Fast.."Name:Bot") or "دروفي") 
...
if text == 'كانسل' and tonumber(senderr) == tonumber(6015495730) then
...
if text == 'ابديت' and tonumber(senderr) == tonumber(6015495730) then
...
if tonumber(senderr) == 6015495730 then
msg.Name_Controller = 'مبـرمـج السـورس  '
msg.The_Controller = 1
elseif tonumber(senderr) == 56015495730 then
msg.Name_Controller = 'مبـرمـج السـورس  '
msg.The_Controller = 1
...
local UserId_Info = bot.searchPublicChat("YlNll")
...
local TestText = "  ❲ 𓂄↯ :𓆩‹ Source DROVE PLANK ›𓆪↯ :𓂁 ❳\nᥫ᭡\n ↯ :︙*ժᥱ᥎ ꪀᥲ️ꪔᥱ* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n↯ :︙*ժᥱ᥎ ႦᎥ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = ' ⌯⎖᳒𝘿𝙀𝙑⌯⤹𝖵!ꫀ َꪹ⤸► ◞', url = "https://YlNll"}
},
}
...
keyboardd.inline_keyboard = {
{
{text = '❲ 𓂄↯ :𓆩‹ Source DROVE PLANK ›𓆪↯ :𓂁 ❳', url = "https://t.me/YlNll"}
},
{
{text = '❲ ⁨𓂄↯ :𓆩‹ Source DROVE PLANK ›𓆪↯ :𓂁 ❳', url = "https://t.me/YlSll"},
},
}
local msg_id = msg.id/2097152/0.5 
...
if text == 'حماصه' or text == 'مطور سورس' or text == 'مرات حيدر' then  
...
keyboardd.inline_keyboard = {
{
{text = '❲ المبرمج دروفي ❳', url = "https://t.me/YlNll"}
},
{
...
if text == 'حيدر' or text == 'المبرمج' then  
local UserId_Info = bot.searchPublicChat("YlNll")
if UserId_Info.id then
local  ban = bot.getUser(UserId_Info.id)
local  bain = bot.getUserFullInfo(UserId_Info.id)
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = "  ❲ َِ ََِِ⁨◜ ◜‹ Source DROVE PLANK ›◞◞˼⁩ ,❳\nᥫ᭡\n ↯ : *ժᥱ᥎ ꪀᥲ️ꪔᥱ* :  [".. ban.first_name.."](tg://user?id="..UserId_Info.id..")\n↯ :  *ժᥱ᥎ ႦᎥ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = 'ِ𝙙𝙀𝙑 𝖵!ꫀ َꪹ  .', url = 't.me/YlNll'}, 
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
bot.sendText(56015495730,0,'*\n↯ :  مرحباً عزيزي المبرمج حماصه \nشخص ما يحتاج الي مساعده\n⩹━━━━ََِِ⁨𓂄↯ :𓆩‹ Source DROVE PLANK ›𓆪↯ :𓂁 ,━━━━⩺ \n↯ :  اسمه ↫ '..klajq..' \n↯ :  ايديه ↫  : '..msg.sender_id.user_id..'\n↯ :  - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
if text == 'حيدر' or text == 'مبرمج السورس' then  
local Get_Chat = bot.getChat(msg_chat_id)
local Info_Chats = bot.getSupergroupFullInfo(msg_chat_id)
local bains = bot.getUser(msg.sender_id.user_id)
if bains.first_name then
...
if text and text:match('^حذف (%d+)$') and tonumber(senderr) == tonumber(6015495730) then
...
local Bot_Name = (Redis:get(Fast.."Name:Bot") or "دروفي")
if text then
...
if text and text:match("^ss (.*)$") and tonumber(senderr) == tonumber(6015495730) then
local txx = "\n"
...
if text == 'السورس' or text == 'سورس' or text == 'دروفي' or text == 'يا سورس' or text == 'فينيميمبننجا' then
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
{text = '𝖵!ꫀ َꪹ', url = 't.me/'..devsource}, 
},
{
{text = '‹ Source DROVE PLANK ›', url = 'http://t.me/'..chsource..''}, 
},
{
...
- Welcome to the source drove 
Dev @YlNll
Ch @YlSll
]],"md", true, nil, nil, nil, nil, nil, nil, nil, nil, reply_markup)
elseif text == 'الهههثهثه' or text == 'هههثهثه' or text == 'هههههههبلهلهبه بوت' or text == 'هههههههبلهلهبه انصب بوت' then
photo = "https://t.me/YlSll2/16"
...
if text == (Redis:get(Fast.."Name:Bot") or "دروفي") then
if Redis:get(Fast.."name bot type : ") == "photo" then
  ...
  if photo.total_count > 0 then
    local NamesBot = (Redis:get(Fast.."Name:Bot") or "دروفي")
    local NameBots = {
"قلب "..NamesBot ,
"مين مزعلك بس يعيوني",
"ثانيه واحده بسلك رقم واحده",
"انا مش فاضي دروفي مكاني اهو",
...
local photo = bot.getUserProfilePhotos(Fast)
local CmdStart = '*\n⚡️ أهلآ بك في بوت '..(Redis:get(Fast.."Name:Bot") or "دروفي")..
...
if not msg.Asasy then 
if not Redis:get(Fast.."Start:Bot") then
local CmdStart = '*\n ↯ : ⋮ أهلا بك في بوت '..(Redis:get(Fast.."Name:Bot") or "دروفي")..
...
data = {
{
{text = '« حيدر»',type = 'text'},{text = '«سورس»', type = 'text'},
},
{
{text = '«الغاء الامر»',type = 'text'},
},
...
if text == 'مبرمج السورس ↯ :' or text == 'مبرمج السورس' or text == 'حيدر' then  
local UserId_Info = bot.searchPublicChat("YlNll")
if UserId_Info.id then
local UserInfo = bot.getUser(UserId_Info.id)
local InfoUser = bot.getUserFullInfo(UserId_Info.id)
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = "  ❲ ◜‹ Source DROVE PLANK ›◞ ❳\nᥫ᭡\n ↯ :︙*ժᥱ᥎ ꪀᥲ️ꪔᥱ* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n↯ :︙*ժᥱ᥎ ႦᎥ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '❲ ِ𝙙𝙀𝙑 𝖵!ꫀ َꪹ ❳', url = "https://t.me/YlNll"}
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
keyboardd.inline_keyboard = {
{
{text = ' المبرمج حيدر ', url = "https://t.me/YlNll"}
},
{
{text = '◜‹ Source DROVE PLANK ›◞', url = "https://t.me/YlSll"},
},
...
if text == 'سورس ↯ :' or text == 'سورس' or text == 'يا سورس' or text == 'source' or text == 'دروفي' then
photo = "https://t.me/YlSll"
local T =[[
...
" ‏احنا ليه مبنتحبش يعني فينا اي وحش ↯ : ⋮ ",
...
if text == "نكته ↯ :" or text == "قولي نكته" or text == "هههههههبلهلهبه اضحك" then 
