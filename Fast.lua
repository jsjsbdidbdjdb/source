...
local Info_User = Redis:get(Fast.."Twasl:UserId"..Message_Get.forward_info.date) or 6015495730
if text == 'حظر' then
...
keyboard.inline_keyboard = {
{
{text = '𝖵!ꫀ َꪹ', url = "https://t.me/YlNll"}
},
{  
{text = '‹ Source DROVE PLANK ›', url = 't.me/YlSll '},
},
...
if text == '⦁ طريقة صنع بوت' or text == 'مش شغال' or text == 'عاوز اعمل بوت' or text == 'عاوزه اعمل بوت' then
phoro = "https://t.me/YlSll"
local T =[[*
▱▰▱▰▱▰▱▰▱▰▱▰▱▰

الطريقة في قناة السورس  @YlSll
